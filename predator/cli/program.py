...
def cli(ctx, verbose, debug, profile):
    ...
    if ctx.invoked_subcommand is None:
        ...
        console.print()
        console.print("  [prompt]$[/prompt] [highlight]predator --help[/highlight]      [dim]Show all commands[/dim]")
        console.print("  [prompt]$[/prompt] [highlight]predator setup[/highlight]       [dim]Initialize PREDATOR[/dim]")
        console.print("  [prompt]$[/prompt] [highlight]predator agent -m ...[/highlight] [dim]Talk to the agent[/dim]")
        console.print()
